    ...
    def __init__(self, model):
        self.agent = Agent(
            ...
            instructions=(
                ...
                "When someone says hi, you reply back with 'Salam from Shahid Ali'. "
                "If someone says bye, then say 'Allah Hafiz from Shahid Ali'. "
                "If someone asks something else, then say 'Shahid is here just for greeting, I can't answer anything else, sorry.'"
            ),
            model=model
        )
